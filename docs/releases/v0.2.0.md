...
**Before:** Running in a Go project reported "No supported languages detected"
...
- [Full Changelog](https://github.com/plexusone/agent-team-release/blob/main/CHANGELOG.md)
- [README](https://github.com/plexusone/agent-team-release/blob/main/README.md)
- [GitHub Repository](https://github.com/plexusone/agent-team-release)
